...
TEST_CASE("ObeliskEstimator Construction and Configuration", "[ObeliskEstimator]") {
    ...
    estimator.set_parameter(rclcpp::Parameter("timer_est_settings", "timer_period_sec:0.1"));
    estimator.set_parameter(rclcpp::Parameter("pub_est_settings", "topic:/estimated_state,history_depth:10"));
...
TEST_CASE("ObeliskEstimator with Empty Sensor Settings", "[ObeliskEstimator]") {
    ...
    estimator.set_parameter(rclcpp::Parameter("sub_sensor_settings", empty_configs));
