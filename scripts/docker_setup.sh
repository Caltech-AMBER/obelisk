...
for arg in "$@"; do
    case $arg in
        ...
        --docker-obk-aliases)
            ...
            shift  # Sets OBELISK_DOCKER_OBK_ALIASES=true for docker, which sets up Obelisk aliases
            ;;
        --help)
...
Options:
  ...
  --docker-obk-aliases   Set OBELISK_DOCKER_OBK_ALIASES=true for docker, which sets up Obelisk aliases
